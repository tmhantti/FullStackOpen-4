...
// testit
    ...
    test('blog with most likes is retrieved correctly', () => {
        const result = listHelper.favoriteBlog(listWithManyBlogs)
        expect(result).toEqual(listWithManyBlogs[2])
    })

    // 4.6*: apufunktioita ja yksikkötestejä, step4
    test('author with most blogs and number of blogs are retrieved correctly', () => {
    ...
    test('author with most likes and their number are retrieved correctly', () => {
